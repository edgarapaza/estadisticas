...
class Oficio
{
    ...
    function Registrar($fecharecepcion,$numofi,$nombre,$tipodoc,$fechaatendida,$estado)
    {
            $sql = "INSERT INTO oficios(fecharecepcion,numofi,nombre,tipodoc,fechaatendida,estado) VALUES
             ('$fecharecepcion','$numofi','$nombre','$tipodoc','$fechaatendida','$estado')";
