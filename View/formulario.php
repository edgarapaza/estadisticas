    ...
    <form action="../Controllers/formulario.controller.php" method="post" class="form">     
     <center> <h5> FORMULARIO DE REGISTRO</h5></center>
        <div>
          <div class="col-2">
            <label for="">Numero de Solicitud:</label>
            <input type="text" name="numsoli" value="<?php echo $numsolicitud;?>">
          </div>
      ...
      <div class="row">
        <div class="col-6">
          ...
          <select name="notario" required="required" class="form-control" required>
            ...
            <option value="Miguel Pino Chavez">Miguel Pino Chavez</option>
            ...
            <option value="Jose Maria Valdivia">Jose Maria Valdivia </option>
            <option value="Juan Clemente Murillo"> Juan Clemente Murillo</option>
            <option value="Juan M. San Martin">Juan M. San Martin </option>
            <option value="Carlos Toranzos">Carlos Toranzos </option>
            <option value="Simon Gonzales">Simon Gonzales </option>
            <option value="Jesus Rivera">Jesus Rivera </option>
            <option value="Mariano C. Garnica">Mariano C. Garnica </option>
            <option value="Alfredo Aramato">Alfredo Aramato </option>
            <option value="Adolfo Ancienta">Adolfo Ancienta </option>
            <option value="Guillermo Garnica">Guillermo Garnica </option>
            <option value="Jose Patron">Jose Patron</option>
